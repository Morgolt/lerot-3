...
class Query:
    ...
    def has_ideal(self, cutoff):
        return cutoff in self.__ideal__

    def set_ideal(self, cutoff, ideal):
        self.__ideal__[cutoff] = ideal

    def get_ideal(self, cutoff):
        return self.__ideal__[cutoff]
